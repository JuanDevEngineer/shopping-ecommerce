...
export function CheckOutCart() {
  ...
  const {cartProducts, isCheckOutCart, closeCartDetail, totalProductPrice, setOrdersData, cleanCart, setSearchInput} = useShopping()
  ...
  return (
    <aside className={cn(
      ...
      <div className="flex justify-between items-center px-3 pt-3">
        <h2 className="font-medium text-xl dark:text-white mb-5">Products Cart</h2>
      ...
      { cartProducts.length === 0 ? (
        ...
        <div className="px-6 h-3/4 overflow-y-scroll">
